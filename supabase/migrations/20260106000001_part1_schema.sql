-- ============================================================================
-- 통합 데이터베이스 스키마 마이그레이션 (RLS 활성화 버전)
-- 작성일: 2026-01-06
-- 목적: 모든 마이그레이션을 통합한 완전한 스키마 정의
--       RLS 정책이 포함된 프로덕션용 마이그레이션
-- 
-- ⚠️ 주의사항:
-- - 이 파일은 프로덕션 환경용입니다 (RLS 활성화 및 정책 포함)
-- - 관리자 테이블(admin_copy_blocks, popup_announcements, admin_security_audit)은 RLS 비활성화 유지
-- - Clerk 인증을 사용하며, JWT sub는 clerk_id(TEXT)입니다
-- - 모든 정책은 인증된 사용자(authenticated)만 접근 가능합니다
-- ============================================================================
...
ALTER TABLE disease_excluded_foods ENABLE ROW LEVEL SECURITY;
ALTER TABLE disease_excluded_foods_extended ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE allergy_derived_ingredients ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE calorie_calculation_formulas ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE health_dashboard_cache ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE pet_vaccine_master ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE weekly_diet_plans ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE weekly_shopping_lists ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE weekly_nutrition_stats ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE kcdc_alerts ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE lifecycle_notification_reminder_settings ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE lifecycle_notification_shares ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE image_cache_cleanup_logs ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE family_intimacy ENABLE ROW LEVEL SECURITY;
ALTER TABLE family_challenges ENABLE ROW LEVEL SECURITY;
ALTER TABLE minigame_records ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE character_game_events ENABLE ROW LEVEL SECURITY;
ALTER TABLE baby_feeding_schedules ENABLE ROW LEVEL SECURITY;
ALTER TABLE character_positions ENABLE ROW LEVEL SECURITY;
ALTER TABLE character_game_interactions ENABLE ROW LEVEL SECURITY;
