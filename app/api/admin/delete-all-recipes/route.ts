/**
 * @file app/api/admin/delete-all-recipes/route.ts
 * @description 현대 레시피북 데이터 전체 삭제 API 엔드포인트
 *
 * 주의: 이 작업은 되돌릴 수 없습니다!
 */
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Service Role 클라이언트를 사용하여 모든 데이터 삭제

    console.log("현대 레시피북 데이터 삭제 시작...");
