    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {(!mfdsRecipe && !mealData) ? (
        ...
        <Card className="border border-slate-200 shadow-md hover:shadow-lg transition-shadow">
          <CardHeader className="border-b border-slate-200 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 px-4 sm:px-6 py-4">
            <CardTitle className="text-lg sm:text-xl font-semibold text-slate-900 flex items-center gap-2">
              <Sparkles className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 shrink-0" />
              <span>식단 정보</span>
            </CardTitle>
          ...
          <CardContent className="pt-4 sm:pt-6 px-4 sm:px-6 pb-4 sm:pb-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
              <div className="text-center p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200/50 hover:border-blue-300 hover:shadow-sm transition-all">
                <div className="text-xs font-medium text-blue-700 mb-1 sm:mb-2">칼로리</div>
                <div className="text-lg sm:text-xl md:text-2xl font-bold text-blue-900">
                  ...
                  <span className="text-xs sm:text-sm font-normal text-blue-600 ml-0.5 sm:ml-1">kcal</span>
                </div>
              </div>
              <div className="text-center p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl bg-gradient-to-br from-purple-50 to-purple-100/50 border border-purple-200/50 hover:border-purple-300 hover:shadow-sm transition-all">
                <div className="text-xs font-medium text-purple-700 mb-1 sm:mb-2">단백질</div>
                <div className="text-lg sm:text-xl md:text-2xl font-bold text-purple-900">
                  ...
                  <span className="text-xs sm:text-sm font-normal text-purple-600 ml-0.5 sm:ml-1">g</span>
                </div>
              </div>
              <div className="text-center p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200/50 hover:border-green-300 hover:shadow-sm transition-all">
                <div className="text-xs font-medium text-green-700 mb-1 sm:mb-2">탄수화물</div>
                <div className="text-lg sm:text-xl md:text-2xl font-bold text-green-900">
                  ...
                  <span className="text-xs sm:text-sm font-normal text-green-600 ml-0.5 sm:ml-1">g</span>
                </div>
              </div>
              <div className="text-center p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl bg-gradient-to-br from-amber-50 to-amber-100/50 border border-amber-200/50 hover:border-amber-300 hover:shadow-sm transition-all">
                <div className="text-xs font-medium text-amber-700 mb-1 sm:mb-2">지방</div>
                <div className="text-lg sm:text-xl md:text-2xl font-bold text-amber-900">
                  ...
                  <span className="text-xs sm:text-sm font-normal text-amber-600 ml-0.5 sm:ml-1">g</span>
                </div>
              </div>
            </div>
            {(mfdsRecipe?.nutrition.sodium || mealData?.sodium) && (
              <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-slate-200">
                <div className="flex items-center justify-between p-3 sm:p-4 rounded-lg bg-slate-50 border border-slate-200">
                  <div>
                    <div className="text-xs sm:text-sm font-medium text-slate-600 mb-1">나트륨</div>
                    <div className="text-base sm:text-lg font-semibold text-slate-900">
                      {(mfdsRecipe?.nutrition.sodium || mealData?.sodium || 0).toFixed(0)} mg
                    </div>
                  </div>
                  <Badge variant="outline" className="text-xs border-slate-300 text-slate-600 bg-white shrink-0">
      ...
      {selectionReason && selectionReason.primaryReasons.length > 0 ? (
        <Card className="border border-slate-200 shadow-md hover:shadow-lg transition-shadow">
          <CardHeader className="border-b border-slate-200 bg-gradient-to-r from-indigo-50/50 to-blue-50/50 px-4 sm:px-6 py-4">
            <CardTitle className="text-lg sm:text-xl font-semibold text-slate-900 flex items-center gap-2">
              <TrendingUp className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-600 shrink-0" />
              <span>왜 이 식단을 선택했나요?</span>
            </CardTitle>
            <CardDescription className="text-xs sm:text-sm text-slate-600 mt-1">
          ...
          <CardContent className="pt-4 sm:pt-6 px-4 sm:px-6 pb-4 sm:pb-6">
            <div className="space-y-2 sm:space-y-3">
              {selectionReason.primaryReasons.map((reason, index) => (
                <div 
                  key={index} 
                  className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg bg-white border border-slate-200 hover:border-indigo-200 hover:bg-indigo-50/30 transition-all shadow-sm"
                >
                  <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white font-semibold text-xs sm:text-sm shadow-sm">
                    {index + 1}
                  </div>
                  <p className="text-xs sm:text-sm leading-relaxed text-slate-700 flex-1 pt-0.5 sm:pt-1">{reason}</p>
                </div>
              ))}
            </div>
          </CardContent>
