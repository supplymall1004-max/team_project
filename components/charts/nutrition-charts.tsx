/**
 * @file components/charts/nutrition-charts.tsx
 * @description 영양 성분 시각화 차트 컴포넌트
 * 
 * 주요 기능:
 * 1. 도넛 차트로 주요 영양 성분 비율 표시
 * 2. 레이더 차트로 영양 성분 전체 비교
 */
...
export function NutritionCharts({ nutrition }: NutritionChartsProps) {
