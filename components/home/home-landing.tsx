  ...
  const quickStartCards: QuickStartCard[] = useMemo(() => [
    {
      ...
      href: "/recipes",
      iconSrc: "/icons/IOS 아이콘 (3)/64.png",
      color: "bg-blue-500",
    ...
    },
    {
      ...
      href: "/royal-recipes",
      iconSrc: "/icons/IOS 아이콘 (3)/93.png",
      color: "bg-amber-500",
    ...
    },
    {
      ...
      iconSrc: "/icons/IOS 아이콘 (3)/100.png",
      color: "bg-amber-600",
    ...
    },
    {
      ...
      iconSrc: "/icons/IOS 아이콘 (3)/80.png",
      color: "bg-purple-600",
    ...
    },
    {
      ...
      iconSrc: "/icons/IOS 아이콘 (3)/71.png",
    ...
    },
    {
      ...
      href: "/recipes/mfds",
      iconSrc: "/icons/IOS 아이콘 (3)/91.png",
      color: "bg-green-600",
      gradient: "bg-gradient-to-br from-emerald-500 via-green-600 to-teal-600",
      category: "recipe",
    },
    ...
    },
    {
      ...
      href: "/diet/weekly",
      iconSrc: "/icons/IOS 아이콘 (3)/57.png",
      color: "bg-purple-500",
    ...
    },
    {
      ...
      href: "/health",
      iconSrc: "/icons/IOS 아이콘 (3)/113.png",
      color: "bg-red-500",
    ...
    },
    {
      ...
      href: "/stories",
      iconSrc: "/icons/IOS 아이콘 (3)/92.png",
      color: "bg-indigo-500",
    ...
    },
    {
      ...
      href: "/health/pets",
      iconSrc: "/icons/IOS 아이콘 (3)/95.png",
      color: "bg-orange-500",
    ...
    },
    {
      ...
      iconSrc: "/icons/IOS 아이콘 (3)/96.png",
      color: "bg-cyan-500",
    ...
    },
    {
      ...
      iconSrc: "/icons/IOS 아이콘 (3)/97.png",
      color: "bg-indigo-500",
    ...
    },
    {
      ...
      iconSrc: "/icons/IOS 아이콘 (3)/73.png",
      color: "bg-blue-500",
    ...
    },
    {
      ...
      iconSrc: "/icons/IOS 아이콘 (3)/102.png",
      color: "bg-purple-500",
    ...
    },
    {
      ...
      description: "편리한 도구들",
      href: "/game/fridge-guardian",
      iconSrc: "/icons/IOS 아이콘 (3)/112.png",
      color: "bg-gray-500",
